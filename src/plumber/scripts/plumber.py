...
@click.option('-f', '--frequency', type=float, default=None, help='Force the frequency at which to generate the PB. Plumber will select the coefficients at the nearest frequency.')
